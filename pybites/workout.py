...
def get_workout_motd(day):
    ...
    If day is in WORKOUT_SCHEDULE retrieve the value (workout) and return the following:
    ...
    Trivia: /etc/motd is a file on Unix-like systems that contains a 'message of the day'""" 

    input_day = day.lower().capitalize()
    try: 
        part = WORKOUT_SCHEDULE[input_day]
    except KeyError: 
        return INVALID_DAY
